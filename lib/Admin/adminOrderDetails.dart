              ...
              return snapshot.hasData
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.all(4.0),
                      child: Text("Orded ID:" +getOrderId),
                    ),
                    Padding(
                      padding: EdgeInsets.all(4.0),
                      child: Text(
                        "Orded at: "+DateFormat("dd MMMM,yyyy-hh:mm aa")
                    ...
                    FutureBuilder<QuerySnapshot>(
                      ...
                      builder: (c, dataSnapshot)
                      {
                        return dataSnapshot.hasData
                            ? OrderCard( itemCount: dataSnapshot.data.documents.length, data: dataSnapshot.data.documents,)
